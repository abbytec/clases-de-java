...
public interface ITourney {
    ...
    /*
     * Prompt in console asking what players do you want to switch using the
     * overloaded method
     */
    void switchPlayers();

    /* Switch two player1 and player2 between their matches */
    void switchPlayers(IPlayer p1, IPlayer p2) throws PlayerIsOnAMatchException, PlayerAlreadyPlayedException;
